...
import { Sparkles, Building2, ShieldCheck, AlertTriangle, FileText, Send, ShieldAlert, Gavel, UserCheck } from 'lucide-react';
import { preloadKerbyAssets } from '@/utils/imagePreloader';

export interface AdminApplicationActionLoaderModalProps {
  isOpen: boolean;
...
const APPROVAL_STAGES = [
  {
    id: 1,
    title: 'Biometric & ID Verification Audit',
    subtitle: 'Kerby is inspecting selfie liveness scan, government ID, and applicant identity...',
    mascotSrc: '/assets/mascot/kerby-admin-audit-specs.png',
    fallbackSrc: '/assets/mascot/kerby-halfbody-blueprint.png',
    icon: Building2,
    color: 'from-amber-500 to-orange-500',
    badge: 'Step 1 of 4: Identity Audit'
  },
  {
    id: 2,
    title: 'Verifying Legal Permits & Compliance',
    subtitle: 'Checking Mayor\'s Business Permit, TARELCO bill, and Fire Safety clearance...',
  ...
  {
    id: 3,
    title: 'Upgrading User Account Role',
    subtitle: 'Promoting account to Verified Landlord and generating host credentials...',
    mascotSrc: '/assets/mascot/kerby-admin-live-broadcast.png',
    fallbackSrc: '/assets/mascot/kerby-landlord-uploading.png',
    icon: UserCheck,
    color: 'from-purple-500 to-pink-500',
    badge: 'Step 3 of 4: Role Promotion'
  },
  {
    id: 4,
    title: 'Host Application Approved!',
    subtitle: 'Super Admin approval recorded. Landlord account is now fully verified!',
...
const REJECTION_STAGES = [
  {
    id: 1,
    title: 'Flagging Verification Issues',
    subtitle: 'Kerby identified items requiring landlord correction (ID, permit, or photo)...',
  ...
  {
    id: 2,
    title: 'Compiling Rejection Guidance',
    subtitle: 'Formulating step-by-step revision notes for the applicant...',
  ...
  {
    id: 3,
    title: 'Dispatching Revision Notice',
    subtitle: 'Sending encrypted email and dashboard notification to landlord applicant...',
    mascotSrc: '/assets/mascot/kerby-admin-dispatch-ticket.png',
    fallbackSrc: '/assets/mascot/kerby-landlord-uploading.png',
    icon: Send,
    color: 'from-blue-500 to-indigo-500',
    badge: 'Step 3 of 4: Dispatching Notice'
  },
  {
    id: 4,
    title: 'Rejection Notice Delivered!',
    subtitle: 'Application status updated to "Rejected". Landlord notified for corrections.',
    mascotSrc: '/assets/mascot/kerby-admin-stamp-rejected.png',
    fallbackSrc: '/assets/mascot/kerby-401-security.png',
    icon: ShieldAlert,
    color: 'from-rose-500 to-red-600',
    badge: 'Step 4 of 4: Rejection Notice Sent'
  }
];

const MODERATION_TIPS_APPROVE = [
  "Super Admin Tip: Approved hosts gain immediate access to property listing creation tools.",
  "Verifying permits thoroughly maintains BoardTAU's high safety standards for student housing.",
  "Verified landlords receive an official trust badge displayed on all their published properties.",
  "Once approved, an automated congratulations email is dispatched to the host."
];

const MODERATION_TIPS_REJECT = [
  "Super Admin Tip: Specific feedback helps applicants fix issues quickly and resubmit.",
  "Rejecting invalid permits prevents non-compliant landlords from listing on BoardTAU.",
  "Applicants receive step-by-step correction guidance in their host onboarding portal.",
  "Landlords can re-upload their documents once corrections are completed."
];

export function AdminApplicationActionLoaderModal({
  isOpen,
  actionType = 'approve',
  ...
  applicantName,
  onComplete
}: AdminApplicationActionLoaderModalProps) {
        ...
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className="min-w-0">
            ...
            <span className="text-[9px] sm:text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-widest block truncate">
              {applicantName ? `Applicant: ${applicantName}` : 'Host Verification Pipeline'}
            </span>
          </div>
        </div>
