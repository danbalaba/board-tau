  ...
  const kpis = [
    ...
    { 
      ...
      tooltip: {
        ...
        description: 'New listings waiting for administrative review.',
        detail: 'Requires verification before going live.',
      }
    },
    { 
