...
import { IconFingerprint, IconShieldLock, IconLockAccess, IconSettingsAutomation } from '@tabler/icons-react';
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
      {[
        ...
        { label: 'Threat Vectors', value: '23', trend: 'Critical Level', icon: IconShieldLock, color: 'text-rose-500', bg: 'bg-rose-500/10' },
