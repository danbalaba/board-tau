...
import { IconChartBar, IconRefresh, IconTrendingUp } from '@tabler/icons-react';
import { Button } from '@/app/admin/components/ui/button';

export function AdminPerformanceHeader() {
  return (
    <motion.div
    ...
    >
      <div className="absolute inset-0 bg-gradient-to-br from-fuchsia-500/5 via-transparent to-pink-500/5 pointer-events-none" />
      ...
      <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          ...
          <div>
            ...
            <div className="flex items-center gap-2 mt-1">
              ...
              <p className="text-[11px] text-gray-500 font-bold uppercase tracking-[0.2em]">
                Detailed telemetric data across global property indices
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3 self-end md:self-auto">
          ...
          >
            <IconTrendingUp size={16} className="text-fuchsia-500" /> Export Trends
          </Button>
          ...
          >
            <IconRefresh size={16} /> Sync Metrics
          </Button>
        </div>
      </div>
    </motion.div>
