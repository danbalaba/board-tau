...
import { IconFileTypePdf, IconTable, IconFileTypeCsv, IconBuildingCommunity } from '@tabler/icons-react';
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
            ...
            <div>
              ...
              <div className="flex items-center gap-2 mt-1">
                ...
                <p className="text-[11px] text-gray-500 dark:text-gray-400 font-bold uppercase tracking-[0.2em]">
                  Overview of all student boarding house & apartment listings
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-3 mt-4 md:mt-0 ml-auto">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-56 bg-white/95 dark:bg-gray-900/95 backdrop-blur-xl border-gray-100 dark:border-gray-800 rounded-2xl p-2 shadow-2xl z-[150]">
            ...
            {isSuperAdmin && (
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-48 bg-white/95 dark:bg-gray-900/95 backdrop-blur-xl border-gray-100 dark:border-gray-800 rounded-2xl p-2 shadow-2xl z-[150]">
            ...
            {onAddProperty && (
              <Button
                ...
                size="sm"
                className="h-9 gap-2 shadow-lg rounded-xl font-black uppercase text-[10px] tracking-widest relative z-10 bg-primary hover:bg-primary/90 text-white shadow-primary/20 transition-all cursor-pointer"
              >
          ...
          <div className="flex items-center gap-3 ml-auto">
            ...
            {onToggleArchived && (
              <button
                ...
                className={cn(
                  'flex items-center gap-2 px-6 py-3 rounded-2xl border transition-all shadow-sm text-[10px] font-black uppercase tracking-widest h-12 cursor-pointer',
                  isArchived
            ...
            {setStatusFilter && (
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <button className="flex items-center gap-2 px-4 py-3 bg-white/50 dark:bg-gray-800/50 rounded-2xl border border-gray-100 dark:border-gray-700 text-[10px] font-black uppercase tracking-widest text-gray-500 hover:text-primary transition-all backdrop-blur-sm shadow-sm h-12 cursor-pointer">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <button className="flex items-center gap-2 px-4 py-3 bg-white/50 dark:bg-gray-800/50 rounded-2xl border border-gray-100 dark:border-gray-700 text-[10px] font-black uppercase tracking-widest text-gray-500 hover:text-primary transition-all backdrop-blur-sm shadow-sm h-12 cursor-pointer">
                  <History size={14} />
                  <span>Sort: {sortBy === 'newest' ? 'Newest' : sortBy === 'oldest' ? 'Oldest' : sortBy === 'price_desc' ? 'Highest Price' : 'Lowest Price'}</span>
                  <ChevronDown size={14} className="opacity-50" />
                </button>
              </DropdownMenuTrigger>
