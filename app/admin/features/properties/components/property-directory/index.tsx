          ...
          >
            <Card className="border-none bg-white/40 dark:bg-gray-900/40 backdrop-blur-xl shadow-lg rounded-[2rem] overflow-hidden group">
              <CardHeader className="flex flex-row items-center justify-between pb-2 space-y-0">
                <CardTitle className="text-[10px] font-black text-gray-500 uppercase tracking-widest">{stat.label}</CardTitle>
              ...
              <CardContent>
                ...
                <div className="flex items-center mt-2 gap-1.5 bg-gray-50 dark:bg-gray-800/50 w-fit px-2 py-1 rounded-lg">
                  ...
                  <span className="text-[9px] font-bold text-gray-400 uppercase tracking-widest ml-1">index</span>
                </div>
              </CardContent>
            </Card>
          </motion.div>
