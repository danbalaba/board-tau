      ...
      <div className="flex flex-col items-center text-center pt-2">
        ...
        <div className="my-3 p-3.5 rounded-2xl bg-slate-100/80 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700/60 w-full flex items-center justify-between gap-3 text-left">
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div className="min-w-0">
              <h4 className="font-bold text-sm text-slate-900 dark:text-slate-100 truncate max-w-[200px]" title={college.name}>
                {college.name}
              </h4>
          ...
          <span className="px-2.5 py-1 rounded-lg bg-rose-500/10 text-rose-600 dark:text-rose-400 font-semibold text-[11px] border border-rose-500/20 shrink-0">
            {college.code}
          </span>
        </div>
        ...
        <div className="flex items-center gap-3 w-full">
          <Button
            ...
            disabled={loading}
            className="flex-1 py-5 rounded-xl border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-300 font-semibold text-xs hover:bg-slate-100 dark:hover:bg-slate-800 transition-all cursor-pointer"
          >
            Cancel
          </Button>
          ...
          <Button
            ...
            disabled={loading}
            className="flex-1 py-5 rounded-xl bg-red-600 hover:bg-red-700 text-white font-semibold text-xs shadow-md transition-all gap-2 cursor-pointer"
          >
            {loading ? (
              <>
