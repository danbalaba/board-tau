...
import { Shield, RefreshCw, Download, Calendar, ChevronDown, Check } from 'lucide-react';
...
export function AdminRolesHeader({ onRefresh, onExport, isFetching, isLoading, range = '30d', onRangeChange, isSuperAdmin = false }: AdminRolesHeaderProps) {
              ...
              <div>
                ...
                <div className="flex items-center gap-2 mt-1">
                  ...
                  <p className="text-[11px] text-gray-500 font-bold uppercase tracking-[0.2em]">
                    Manage user access levels across the platform
                  </p>
                </div>
              </div>
            </>
        ...
        <div className="flex items-center gap-3 self-end md:self-auto flex-wrap">
          {(isLoading || isFetching) ? (
            <div className="flex items-center gap-3">
              ...
              {isSuperAdmin && <Skeleton className="h-9 w-24 rounded-xl" />}
            </div>
          ) : (
            <>
              {/* Date Range */}
              ...
              <div className="flex flex-wrap items-center gap-3">
                ...
                {isSuperAdmin && onExport && (
                  <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                      <Button size="sm" className="h-9 gap-2 rounded-xl bg-emerald-500 hover:bg-emerald-600 text-white shadow-xl shadow-emerald-500/20 font-black uppercase text-[10px] tracking-[0.2em] transition-all relative z-10">
                        <Download size={14} />
                        Export
