          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-3 md:col-span-2">
              ...
              <div className="h-48 w-full rounded-2xl overflow-hidden border border-gray-100 dark:border-gray-800 mt-2 relative group">
                ...
                />
                <div className="absolute top-3 left-3 pointer-events-none z-[401]">
                  <p className="text-[10px] font-black text-white px-3 py-2 bg-primary/90 backdrop-blur-md rounded-xl opacity-0 group-hover:opacity-100 transition-all uppercase tracking-[0.1em] -translate-x-2 group-hover:translate-x-0 duration-500 shadow-xl border border-white/20 whitespace-nowrap">
