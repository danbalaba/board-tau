              ...
              <section className="space-y-8">
                 ...
                 <div>
                   ...
                   <div className="grid grid-cols-2 gap-3">
                     {[
                       { label: 'WiFi', icon: IconWifi, active: property.amenities?.wifi },
                       { label: 'Parking', icon: IconParking, active: property.amenities?.parking },
                       { label: 'Pool', icon: IconSwimming, active: property.amenities?.pool },
                       { label: 'Gym', icon: IconBarbell, active: property.amenities?.gym },
                       { label: 'AC', icon: IconAirConditioning, active: property.amenities?.airConditioning },
                       { label: 'Laundry', icon: IconWashMachine, active: property.amenities?.laundry },
                     ].map((item, i) => (
                       <div key={i} className={cn(
                         "flex items-center gap-3 px-4 py-3 rounded-2xl border transition-all",
                         item.active 
                           ? "bg-primary/5 border-primary/10 text-primary" 
                           : "bg-gray-50 dark:bg-gray-800 border-gray-100 dark:border-gray-700 text-gray-400 opacity-40"
                       )}>
                         <item.icon size={14} />
                 ...
                 <div>
                   ...
                   <div className="flex flex-wrap gap-2">
                     {[
                       ...
                       { label: 'CCTV Monitoring', icon: IconDeviceCctv, active: property.features?.cctv },
                       { label: 'Fire Safety', icon: IconFlame, active: property.features?.fireSafety },
                       { label: 'Near Transport', icon: IconBus, active: property.features?.nearTransport },
                       { label: 'Study Friendly', icon: IconBook, active: property.features?.studyFriendly },
                       { label: 'Quiet Zone', icon: IconSeeding, active: property.features?.quietEnvironment },
                       { label: 'Flexible Lease', icon: IconCertificate, active: property.features?.flexibleLease },
