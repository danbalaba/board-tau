...
export function LandlordAnalyticsStatsGrid({ stats, occupancyRate }: LandlordAnalyticsStatsGridProps) {
  const statsCards = [
        ...
        return (
          ...
          >
            ...
            <div>
              ...
              <p className="text-lg font-bold text-gray-900 dark:text-white tracking-tight">{stat.value}</p>
              <div className="flex items-center gap-1 mt-0.5">
                <span className="text-[9px] text-emerald-600 dark:text-emerald-400 font-bold">+15.2%</span>
              </div>
            </div>
          </div>
        );
