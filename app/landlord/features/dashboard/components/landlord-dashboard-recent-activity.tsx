...
import { recentActivities } from '@/app/landlord/constants/dashboard-data';

export default function LandlordDashboardRecentActivity() {
  return (
      ...
      <div className="space-y-3">
        {recentActivities.map((activity) => {
          ...
          const accentColor: Record<string, string> = {
            ...
            emerald: 'bg-emerald-50 dark:bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 border-emerald-100 dark:border-amber-900/30',
