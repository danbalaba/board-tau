...
interface LandlordTopbarHeaderProps {
  user: {
    id: string;
    name: string | null;
    email: string | null;
...
export default function LandlordTopbarHeader({ user }: LandlordTopbarHeaderProps) {
  ...
  return (
    <>
      ...
      {/* Modals - Temporarily keeping these here until Phase 4 (Settings Hub) */}
