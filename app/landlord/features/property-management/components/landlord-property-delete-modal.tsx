  ...
  return createPortal(
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4">
      ...
      <motion.div 
        ...
        className="relative bg-white dark:bg-[#111827] rounded-[2.5rem] border border-gray-100 dark:border-white/10 p-10 max-w-md w-full shadow-2xl overflow-hidden"
      >
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <h3 className="text-3xl font-black text-gray-900 dark:text-white mb-3 uppercase tracking-tight leading-none">Delete Permanently</h3>
          <p className="text-[13px] text-gray-400 mb-10 leading-relaxed font-medium px-4">
            You are about to permanently delete <span className="font-black text-gray-900 dark:text-white underline decoration-rose-500/50 decoration-2 underline-offset-4">"{property.title}"</span>. 
            This will remove all <span className="text-rose-500 font-bold">gallery images</span> and <span className="text-rose-400 font-bold">room photos</span> from our servers.
          </p>
