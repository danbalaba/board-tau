...
interface LandlordPropertyEditorEditProps {
  initialData: any;
}

export default function LandlordPropertyEditorEdit({ initialData }: LandlordPropertyEditorEditProps) {
                      ...
                      <Section id="config" title="Listing Rules" icon={ShieldCheck} description="Security & occupancy conditions" setActiveSection={setActiveSection}>
                        <div className="space-y-12">
                          ...
                          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 border-t border-gray-100 dark:border-gray-800 pt-10">
                            ...
                            />
                            <LocalCheckbox 
                              id="flexibleLease" label="Flexible Lease" checked={formData.features.flexibleLease} 
                              onChange={() => setFormData(prev => ({ ...prev, features: { ...prev.features, flexibleLease: !prev.features.flexibleLease } }))}
                            />
                          </div>
                        </div>
                      </Section>
