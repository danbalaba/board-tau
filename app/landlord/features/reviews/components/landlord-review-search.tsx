...
export function LandlordReviewSearch({
  searchQuery,
  setSearchQuery,
  reviews
              ...
              {suggestions.map((review) => (
                ...
                >
                  ...
                  <div className="flex flex-col min-w-0">
                    ...
                    <span className="text-[10px] text-gray-500 truncate font-medium flex items-center gap-1">
                      <IconStar size={10} className="text-amber-500 fill-amber-500" /> {review.rating} • {review.listing.title}
                    </span>
                  </div>
                </button>
              ))}
