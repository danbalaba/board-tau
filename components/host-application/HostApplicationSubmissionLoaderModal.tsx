...
const STAGES = [
  {
    ...
    subtitle: 'Kerby is checking your selfie photo and ID card details...',
    mascotSrc: '/assets/mascot/kerby-desktop-scanner.png',
    fallbackSrc: '/assets/mascot/kerby-500-mechanic.png',
    icon: UserCheck,
    color: 'from-blue-500 to-indigo-500',
    badge: 'Step 1 of 4: Verifying Identity'
  },
  {
    id: 2,
    title: 'Checking Business & Safety Permits',
    subtitle: 'Reviewing your business permit and safety documents...',
    mascotSrc: '/assets/mascot/kerby-permit-fullbody.png',
    fallbackSrc: '/assets/mascot/kerby-landlord-checklist.png',
    icon: ShieldCheck,
    color: 'from-amber-500 to-orange-500',
    badge: 'Step 2 of 4: Checking Permits'
  },
  {
    id: 3,
    title: 'Uploading Documents & Building Photos',
    subtitle: 'Securely uploading your verification documents and facade photos...',
    mascotSrc: '/assets/mascot/kerby-landlord-uploading.png',
    fallbackSrc: '/assets/mascot/kerby-uniform-driving.png',
    icon: CloudUpload,
    color: 'from-purple-500 to-pink-500',
    badge: 'Step 3 of 4: Uploading Documents'
  },
  {
    id: 4,
    title: 'Application Submitted Successfully!',
    subtitle: 'Sent to BoardTAU Team for verification. We will notify you once approved!',
    mascotSrc: '/assets/mascot/kerby-desktop-celebration.png',
...
const LOADING_TIPS = [
  "Did you know? Verified Landlords near TAU main gate receive up to 4x more tenant inquiry requests!",
  "BoardTAU strictly encrypts all biometric selfie and ID verification data for privacy security.",
  "Clear business permits and fire safety certificates get reviewed within 24 hours by BoardTAU Admin.",
  "Once approved as a Landlord, you can instantly publish room listings and manage student reservations."
];

export function HostApplicationSubmissionLoaderModal({
  isOpen,
  progress: externalProgress,
  stage: externalStage,
  onComplete
}: HostApplicationSubmissionLoaderModalProps) {
  ...
  useEffect(() => {
    ...
    const duration = 8000; // 8.0 seconds total flow
  ...
  return (
    <div className="fixed inset-0 z-[10000] flex flex-col justify-between items-center p-4 sm:p-12 bg-slate-50/95 dark:bg-slate-950/95 backdrop-blur-3xl overflow-y-auto overflow-x-hidden max-w-full w-full text-slate-900 dark:text-white antialiased transition-colors duration-300">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-1/4 right-1/4 translate-x-1/2 translate-y-1/2 w-96 h-96 rounded-full bg-emerald-500/10 dark:bg-emerald-500/20 blur-[130px] animate-pulse" />
      </div>
      ...
      <div className="w-full max-w-4xl flex flex-wrap items-center justify-between gap-2.5 sm:gap-3 z-10 min-w-0">
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className="min-w-0">
            <h2 className="text-xs sm:text-sm font-black uppercase tracking-wider text-slate-900 dark:text-white truncate">BoardTAU Landlord Portal</h2>
            <span className="text-[9px] sm:text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-widest block truncate">Host Registration Verification Pipeline</span>
          </div>
        </div>
      ...
      <div className="w-full max-w-2xl my-auto py-6 sm:py-8 flex flex-col items-center text-center z-10 space-y-4 sm:space-y-6">
        ...
        <div className="space-y-2 max-w-lg">
          <AnimatePresence mode="wait">
            ...
            >
              <h3 className="text-2xl sm:text-3xl font-black text-slate-900 dark:text-white leading-snug tracking-tight font-[family-name:var(--font-outfit)]">
      ...
      <div className="w-full max-w-2xl z-10">
        <div className="p-4 sm:p-5 rounded-3xl bg-white/95 dark:bg-slate-900/80 border border-slate-200 dark:border-slate-800/80 text-left flex items-start gap-4 shadow-xl shadow-slate-200/60 dark:shadow-none backdrop-blur-md">
          ...
          <div className="flex-1 min-w-0">
            <span className="text-[10px] font-black text-amber-600 dark:text-amber-400 uppercase tracking-widest block mb-0.5">Verification Tip</span>
            <AnimatePresence mode="wait">
              <motion.p
                key={tipIdx}
