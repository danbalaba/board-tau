...
import AccessibilitySupportContent from '../AccessibilitySupportContent';
...
describe('AccessibilitySupportContent', () => {
  it('renders correctly', () => {
    const { container } = render(<AccessibilitySupportContent />);
