  ...
  const footerSections = [
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'Safety Guidelines', href: '/support/safety-guidelines' },
        { name: 'How Booking Works', href: '/support/how-booking-works' },
        { name: 'Cancellation Policy', href: '/support/cancellation-policy' },
    ...
    },
    {
      title: 'Hosting',
      links: [
        { name: 'List Your Boarding House', href: '/hosting/list' },
        { name: 'Become a BoardTAU Host', href: '/hosting/list' },
        { name: 'Hosting Guidelines', href: '/hosting/guidelines' },
        { name: 'Host Responsibilities', href: '/hosting/responsibilities' },
        { name: 'Safety for Hosts', href: '/hosting/safety' },
