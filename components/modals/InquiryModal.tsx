...
const InquiryModal: React.FC<InquiryModalProps> = ({
  ...
  return (
      <Modal.Window name={`inquire-${room.id}`}>
        <div>
          <Modal.WindowHeader title={submitted ? "Inquiry Sent!" : "Inquiry"} />
          <div className="p-6">
                ...
                <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 border border-gray-200 dark:border-gray-700">
                  ...
                  <div className="mb-6 space-y-3">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-semibold text-text-primary dark:text-gray-100">
                        {formData.stayDuration} month{parseInt(formData.stayDuration) > 1 ? 's' : ''}
                      </span>
                    </div>
                    <div className="flex justify-between">
