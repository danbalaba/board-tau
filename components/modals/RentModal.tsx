...
const locationOptions: CountrySelectValue[] = [...philippinesPlaces, ...(countries as CountrySelectValue[])];
const PH_PLACE_VALUES = ["tarlac", "tarlac-agricultural-university", "camiling"];
function normalizeListingLocation(data: FieldValues): FieldValues {
  const loc = data.location as CountrySelectValue | null;
  if (!loc || !PH_PLACE_VALUES.includes(loc.value)) return data;
  return {
    ...data,
    location: { ...loc, label: "Philippines" },
  };
}
...
const RentModal = ({ onCloseModal }: { onCloseModal?: () => void }) => {
      ...
      case STEPS.LOCATION:
        return (
          <div className="flex flex-col gap-6">
            ...
            />
            <CountrySelect value={location} onChange={setCustomValue} options={locationOptions} />
  ...
  return (
    <div className="w-full h-full flex flex-col">
      ...
      <form
        className="flex-1  md:h-auto border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white dark:bg-gray-800 outline-none focus:outline-none "
