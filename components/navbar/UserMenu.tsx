        ...
        <Modal>
          ...
          <Menu>
            <Menu.Toggle id="user-menu">
              <button
                type="button"
                className=" p-4 md:py-1 md:px-2 border-[1px]   border-neutral-200 dark:border-gray-700  flex  flex-row  items-center   gap-3   rounded-full   cursor-pointer   hover:shadow-md   transition duration-300 bg-white dark:bg-gray-800"
              >
            ...
            <Menu.List className="shadow-[0_0_36px_4px_rgba(0,0,0,0.075)] rounded-xl bg-white dark:bg-gray-800 text-sm">
              {user ? (
                <>
                  {menuItems.map((item) => (
                    <MenuItem
