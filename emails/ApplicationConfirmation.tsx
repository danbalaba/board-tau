...
export const ApplicationConfirmation = ({
  ...
  return (
    <Html>
      ...
      <Preview>Application Received - BoardTAU</Preview>
      <Body style={styles.body}>
        <Container style={styles.container} className="main-card">
          ...
          <Section style={styles.content}>
            ...
            <Text style={styles.subtext}>Dear {userName}, thank you for your interest in joining BoardTAU. Your application is now under review.</Text>
            ...
            <Section style={styles.summaryCard}>
              ...
              <Text style={{ ...styles.value, color: "#eab308", margin: "0" }}>Pending Review</Text>
            </Section>
