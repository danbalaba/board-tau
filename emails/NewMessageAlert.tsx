...
export const NewMessageAlert = ({
  ...
  return (
    <Html>
      ...
      <Preview>New message from {senderName} regarding {listingTitle}</Preview>
      <Body style={styles.body}>
        <Container style={styles.container} className="main-card">
          ...
          <Section style={styles.content}>
            ...
            <Section style={styles.messageBubble}>
               <Row>
                <Column width="48">
                   <Text style={{ fontSize: "24px", margin: "0" }}>💬</Text>
                </Column>
                <Column>
                  <Text style={{ color: "#94a3b8", fontSize: "11px", fontWeight: "700", textTransform: "uppercase", margin: "0" }}>From {senderName}</Text>
                  <Text style={{ color: "#f8fafc", fontSize: "15px", fontStyle: "italic", lineHeight: "1.5", marginTop: "8px", margin: "8px 0 0" }}>"{messageContent}"</Text>
                </Column>
              </Row>
            </Section>

            <Link href={viewReplyLink} style={styles.button}>View & Reply</Link>
          </Section>
