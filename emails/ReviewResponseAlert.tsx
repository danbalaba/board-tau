...
interface ReviewResponseAlertProps {
  tenantName: string;
  listingTitle: string;
  response: string;
...
export const ReviewResponseAlert = ({
  ...
  return (
    <Html>
      ...
      <Preview>New response to your review of {listingTitle}</Preview>
      <Body style={styles.body}>
        <Container style={styles.container} className="main-card">
          ...
          <Section style={styles.content}>
            <Heading style={styles.heading}>Landlord Replied!</Heading>
            <Text style={{ color: "#94a3b8", fontSize: "14px", lineHeight: "22px", margin: "0 0 30px", textAlign: "center" }}>Hi {tenantName}, the landlord of <strong>{listingTitle}</strong> has responded to your review.</Text>

            <Section style={styles.responseCard}>
              <Text style={styles.label}>Landlord's Message</Text>
              <Text style={{ color: "#ffffff", fontSize: "15px", fontStyle: "italic", lineHeight: "1.6", margin: "0" }}>"{response}"</Text>
            </Section>

            <Link href={viewReviewsLink} style={styles.button}>View All Reviews</Link>
          </Section>
