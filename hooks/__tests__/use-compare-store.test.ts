...
describe('useCompareStore', () => {
  ...
  it('limits the maximum number of listings to 3 (blocks 4th item addition)', () => {
    const { result } = renderHook(() => useCompareStore());
    ...
    act(() => {
      ...
      const added = result.current.addListing('listing_4'); // Should return false and block addition
